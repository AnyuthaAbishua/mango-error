...
function setup() {
	...
	mango1 = new Mango (900,180,50,10);
	mango2 = new Mango (970,150,50,10);
	mango3 =new Mango (1000,300,40,20);
	mango4 =new Mango (950,300,60,20);
	mango5 =new Mango (1030,130,30,40);
	mango6 = new Mango (1060,300,60,50);
	mango7 =new Mango (1080,150,40,80);
	mango8 = new Mango (1140,170,60,50);
	mango9 = new Mango (1140,320,70,40);
	mango10 = new Mango (1220,240,80,40);
